...
class Onboarding extends React.Component {
  ...
  render () {
    ...
    const bodies = [`<h1>This is Rizzle</h1>
      ...
      <p>Then you read the article. That’s it.</p>`,
      ...
      `<h1 style="font-size: 1.6rem !important;">Congratulations</h1>
      <hr />
      ...
      <p>Before you start though, you will need an account. You can use 3rd party RSS services (just <a href="https://www.feedwrangler.net">FeedWrangler</a> for now), or you can create a <b>Rizzle</b> account.`
    ]
